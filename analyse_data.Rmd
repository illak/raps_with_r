...
get_laspeyeres <- function(dataset){
  ...
  # Esto permite "obtener" el contenido (string) del argumento 'dataset'
  # pasado por el usuario. Es útil para revisar el contenido del string
  # y tomar decisiones en base a esto.
